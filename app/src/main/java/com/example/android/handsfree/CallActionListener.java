...
public class CallActionListener extends ActionBarActivity {
    ...
    public static boolean isToggleOn=true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if (isHeadsetPlugged|isToggleOn) {
            if (!isBlacklisted) {
                Log.i("Oncreate", TextToSpeak);
        ...
        /*Background Services*/
        //Intent callIntentSevice = new Intent(Intent.ACTION_SYNC, null, this, BackgroundService.class);
        //startService(callIntentSevice);
